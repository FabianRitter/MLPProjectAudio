...
def get_args():
    ...
    parser.add_argument('--image_height', nargs="?", type=int, default=32000, help='Height of image data')
    parser.add_argument('--image_width', nargs="?", type=int, default=64, help='Width of image data')
