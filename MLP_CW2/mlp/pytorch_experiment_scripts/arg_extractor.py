...
def get_args():
    ...
    parser.add_argument('--image_height', nargs="?", type=int, default=96, help='Height of image data')
    parser.add_argument('--image_width', nargs="?", type=int, default=83, help='Width of image data')
