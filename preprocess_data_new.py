...
def convert2mel(audio,base_path,fs,fmax,n_mels,number_of_frames):
    """
...
all_dict = {}
all_inputs = [convert2mel(audio,base_path,fs,fmax,n_mels,number_of_frames) for audio in fname]                      
